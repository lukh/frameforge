...
class CreateEndMiterCommand:
    def GetResources(self):
        return {
            ...
            "ToolTip": translate(
                "MetalWB",
                "<html><head/><body><p><b>Create Miter Ends</b> \
                    <br><br> \
                    Select two profiles. \
                    </p></body></html>",
            ),
    ...
    def Activated(self):
        ...
        if len(sel) == 2:
            self.make_end_miter_profile(
                sel[0].Object, [(sel[1].Object, sel[1].SubElementNames)]
            )
            self.make_end_miter_profile(
                sel[1].Object, [(sel[0].Object, sel[0].SubElementNames)]
            )
