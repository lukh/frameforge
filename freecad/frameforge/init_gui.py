...
class FrameForge(Gui.Workbench):
    ...
    def Initialize(self):
        ...
        """
        from freecad.frameforge import (create_end_miter_tool,
        ...
        App.Console.PrintMessage(
            translate("frameforge", "Switching to frameforge") + "\n"
        )

        self.appendToolbar(
            translate("frameforge", "Drawing Primitives"), self.toolbox_drawing
        )
        self.appendMenu(
            translate("frameforge", "Drawing Primitives"), self.toolbox_drawing
        )
        ...
        self.appendToolbar(
            translate("frameforge", "Frameforge"), self.toolbox_frameforge
        )
        self.appendMenu(translate("frameforge", "Frameforge"), self.toolbox_frameforge)

        self.appendToolbar(
            translate("frameforge", "Part Primitives"), self.toolbox_part
        )
    ...
    def Activated(self):
        ...
        """
        App.Console.PrintMessage(
            translate("frameforge", "Workbench frameforge activated.") + "\n"
        )
    ...
    def Deactivated(self):
        ...
        """
        App.Console.PrintMessage(
            translate("frameforge", "Workbench frameforge de-activated.") + "\n"
        )
