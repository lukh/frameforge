...
class ParametricLine:
    ...
    def __init__(self, obj):
        """Add the properties"""
        obj.addProperty(
            "App::PropertyLinkSub", "Vertex1", "ParametricLine", "First Vertex"
        )
        obj.addProperty(
            "App::PropertyLinkSub", "Vertex2", "ParametricLine", "Second Vertex"
        )
        obj.Proxy = self
...
class CreateParametricLineCommand:
    ...
    def make_parametric_line(self, source):
        line_object = App.ActiveDocument.addObject(
            "Part::FeaturePython", "ParametricLine"
        )
