...
class Profile:
    ...
    def __init__(
        ...
        obj.addProperty(
            "App::PropertyFloat", "ProfileWidth", "Profile", ""
        ).ProfileWidth = init_w
        obj.addProperty(
            "App::PropertyFloat", "ProfileLength", "Profile", ""
        ).ProfileLength = init_len  # should it be ?

        obj.addProperty(
            "App::PropertyFloat",
            "Thickness",
            "Profile",
            "Thickness of all the profile or the web",
        ).Thickness = init_mt
        obj.addProperty(
            "App::PropertyFloat",
            "ThicknessFlange",
        ...
        obj.addProperty(
            "App::PropertyFloat", "RadiusLarge", "Profile", "Large radius"
        ).RadiusLarge = init_r1
        obj.addProperty(
            "App::PropertyFloat", "RadiusSmall", "Profile", "Small radius"
        ).RadiusSmall = init_r2
        obj.addProperty(
            "App::PropertyBool",
            "MakeFillet",
            "Profile",
            "Whether to draw the fillets or not",
        ).MakeFillet = init_mf
        ...
        if not bevels_combined:
            obj.addProperty(
                ...
                "BevelStartCut1",
                "Profile",
                "Bevel on First axle at the start of the profile",
            ).BevelStartCut1 = 0
            obj.addProperty(
                "App::PropertyFloat",
                "BevelStartCut2",
            ...
            obj.addProperty(
                ...
                "BevelEndCut1",
                "Profile",
                "Bevel on First axle at the end of the profile",
            ).BevelEndCut1 = 0
            obj.addProperty(
                "App::PropertyFloat",
                "BevelEndCut2",
        ...
        if bevels_combined:
            obj.addProperty(
                ...
                "BevelStartCut",
                "Profile",
                "Bevel at the start of the profile",
            ).BevelStartCut = 0
            obj.addProperty(
                "App::PropertyFloat",
                "BevelStartRotate",
                "Profile",
                "Rotate the second cut on Profile axle",
            ).BevelStartRotate = 0
            obj.addProperty(
                "App::PropertyFloat",
                "BevelEndCut",
        ...
        obj.addProperty(
            ...
            "CenteredOnHeight",
            "Profile",
            "Choose corner or profile centre as origin",
        ...
        if fam == "UPE":
            obj.addProperty(
                "App::PropertyBool", "UPN", "Profile", "UPE style or UPN style"
            ).UPN = False
            obj.addProperty(
                "App::PropertyFloat", "FlangeAngle", "Profile"
            ).FlangeAngle = 4.57
        if fam == "UPN":
            obj.addProperty(
                "App::PropertyBool", "UPN", "Profile", "UPE style or UPN style"
        ...
        if fam == "IPE" or fam == "HEA" or fam == "HEB" or fam == "HEM":
            obj.addProperty(
                "App::PropertyBool", "IPN", "Profile", "IPE/HEA style or IPN style"
            ).IPN = False
            obj.addProperty(
                "App::PropertyFloat", "FlangeAngle", "Profile"
            ).FlangeAngle = 8
        ...
        obj.addProperty(
            "App::PropertyLength", "Width", "Structure", "Parameter for structure"
        ).Width = obj.ProfileWidth  # Property for structure
        obj.addProperty(
            "App::PropertyLength", "Height", "Structure", "Parameter for structure"
        ).Height = obj.ProfileLength  # Property for structure
        obj.addProperty(
            "App::PropertyLength",
            "Length",
            "Structure",
        ...
        obj.addProperty(
            "App::PropertyFloat", "OffsetA", "Structure", "Parameter for structure"
        ).OffsetA = 0.0  # Property for structure

        obj.addProperty(
            "App::PropertyFloat", "OffsetB", "Structure", "Parameter for structure"
        ).OffsetB = 0.0  # Property for structure

        if link_sub:
            obj.addProperty(
                "App::PropertyLinkSub", "Target", "Base", "Target face"
            ).Target = link_sub
    ...
    def on_changed(self, obj, p):
        ...
        self.onChanged(obj, p)

    def onChanged(self, obj, prop):
        """Standard FreeCAD callback when properties change"""
        # List of properties that require shape regeneration
        update_props = [
            "ProfileWidth",
            "ProfileHeight",
            "Thickness",
    ...
    def execute(self, obj):
        ...
        # Calculate bevel parameters - needed for both approaches
        ...
        if generator:
            ...
            if self.bevels_combined:
                any_bevel = (
                    obj.BevelStartCut
                    or obj.BevelEndCut
                    or obj.BevelStartRotate
                    or obj.BevelEndRotate
                )
            else:
                any_bevel = (
                    obj.BevelStartCut1
                    or obj.BevelEndCut1
                    or obj.BevelStartCut2
                    or obj.BevelEndCut2
                )
        ...
        # Fallback to traditional approach (existing code)
            ...
            error_msg = f"Profile family '{self.fam}' is not implemented in the generator system"
